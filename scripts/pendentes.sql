CREATE OR ALTER PROCEDURE TITULOS_PENDENTES (
    diapgto integer,
    gp char(1),
    insc integer,
    insc1 integer,
...
declare variable rua varchar(80);
declare variable cep char(9);
declare variable uf char(2);
declare variable bairro varchar(60);
declare variable municipio varchar(60);
  ...
  FOR SELECT rc.id_recebimentos, RC.STATUS, RC.EMISSAO, RC.VENCIMENTO, RC.valor_nf
    ...
    FROM recebimentos RC
     ...
     begin
       ...
       /* tem título pendente                          */
       valorpendente = 0;
       SELECT sum(VALOR_NF) FROM RECEBIMENTOS WHERE ID_SOCIO = :id and STATUS = 'Pendente'
         INTO :VALORPENDENTE;

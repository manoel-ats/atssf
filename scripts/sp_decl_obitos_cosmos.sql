CREATE OR ALTER PROCEDURE SP_DECL_OBITOS_COSMOS (
    pid integer)
returns (
    codigo integer,
...
BEGIN
   ...
   FOR SELECT CODIGO, FALECIDO, SEXO, COR, DATA_NASC, udf_age(DATA_NASC), ESTADO_CIVIL, PROFISSAO, NATURALIDADE
        ...
        , DECLA_NACIONALIDADE, FALEC_ESTCIVIL, DATA_SISTEMA , CPF_DECLARANTE, SSP_DECLARANTE, NACIONALIDADE FROM OBITOS WHERE (ID = :PID)
   INTO:CODIGO,:FALECIDO,:SEXO,:COR,:DATA_NASC,:IDADE,:ESTADO_CIVIL,:PROFISSAO,:NATURALIDADE
        ...
        ,:IMSS,:n_beneficio,:declarante_nacionalidade,:falecido_estcivil, :DATA_DECLARACAO , :CPF_DECLARANTE, :SSP_DECLARANTE, :NACIONALIDADE
   DO
   BEGIN
  SUSPEND;
END

inherited fReceitas: TfReceitas
  Left = 72
  Top = 49
  Width = 680
  Height = 510
  ...
  object SpeedButton12: TSpeedButton [10]
    Left = 536
    Top = 203
    Width = 95
    Height = 39
  ...
  object Panel2: TPanel [29]
    ...
    object Label16: TLabel
      ...
      Width = 275
      Height = 24
      Caption = 'Lan'#231'amento de Receitas'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -21
  ...
  object DBComboBox1: TDBComboBox [31]
    Left = 490
    Top = 120
    Width = 63
    Height = 24
  ...
  object sds_pag: TSQLDataSet
    CommandText = 
      'select p.* '#13#10'        , d.NOME_DEP '#13#10'        , c.DESCRICAO '#13#10'from' +
      ' DESPESA_RECEITA p '#13#10'left outer join DEPENDENTE d   '#13#10'on d.ID_DE' +
      'P = p.ID_FORNECEDOR   '#13#10'left outer join PRODUTOS C on '#13#10'c.ID_PRO' +
      'DUTO = p.CODCCUSTO '#13#10'where p.ID_DEPREC = :pid and p.TIPO = '#39'R'#39' '
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    object sds_pagNOME: TStringField
      FieldName = 'NOME'
      ProviderFlags = [pfInUpdate]
      Size = 80
    end
    object sds_pagNOME_DEP: TStringField
      FieldName = 'NOME_DEP'
      ProviderFlags = []
      Size = 80
    end
  ...
  object cds_pag: TClientDataSet
    ...
    Left = 344
    Top = 360
    object cds_pagID_DEPREC: TIntegerField
      FieldName = 'ID_DEPREC'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cds_pagID_FORNECEDOR: TIntegerField
      FieldName = 'ID_FORNECEDOR'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagDATAEMISAO: TDateField
      FieldName = 'DATAEMISAO'
      ProviderFlags = [pfInUpdate]
      Required = True
      EditMask = '!99/99/0000;1;_'
    end
    object cds_pagDATAVENCIMENTO: TDateField
      FieldName = 'DATAVENCIMENTO'
      ProviderFlags = [pfInUpdate]
      Required = True
      EditMask = '!99/99/0000;1;_'
    end
    object cds_pagID_COMPRADOR: TSmallintField
      FieldName = 'ID_COMPRADOR'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagSTATUS: TSmallintField
      FieldName = 'STATUS'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagID_USUARIO: TSmallintField
      FieldName = 'ID_USUARIO'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagDATASISTEMA: TDateField
      FieldName = 'DATASISTEMA'
      ProviderFlags = [pfInUpdate]
      EditMask = '!99/99/0000;1;_'
    end
    object cds_pagNOTAFISCAL: TIntegerField
      FieldName = 'NOTAFISCAL'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagSERIE: TStringField
      FieldName = 'SERIE'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagCODCCUSTO: TSmallintField
      FieldName = 'CODCCUSTO'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagN_PARCELA: TSmallintField
      FieldName = 'N_PARCELA'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagN_DOCUMENTO: TStringField
      FieldName = 'N_DOCUMENTO'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagCAIXA: TSmallintField
      FieldName = 'CAIXA'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagVALOR: TFloatField
      FieldName = 'VALOR'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = ',#0.00'
    end
    object cds_pagDESCONTO: TFloatField
      FieldName = 'DESCONTO'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagMULTA_JUROS: TFloatField
      FieldName = 'MULTA_JUROS'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagAPAGAR: TFloatField
      FieldName = 'APAGAR'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = ',#0.00'
    end
    object cds_pagVALOR_PAGAR: TFloatField
      FieldName = 'VALOR_PAGAR'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = ',#0.00'
    end
    object cds_pagENTRADA: TFloatField
      FieldName = 'ENTRADA'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = ',#0.00'
    end
    object cds_pagN_BOLETO: TStringField
      FieldName = 'N_BOLETO'
      ProviderFlags = [pfInUpdate]
      Size = 30
    end
    object cds_pagSTATUS1: TStringField
      FieldName = 'STATUS1'
      ProviderFlags = [pfInUpdate]
      FixedChar = True
      Size = 1
    end
    object cds_pagVALOR_ICMS: TFloatField
      FieldName = 'VALOR_ICMS'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = ',#0.00'
    end
    object cds_pagVALOR_IPI: TFloatField
      FieldName = 'VALOR_IPI'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = ',#0.00'
    end
    object cds_pagVALOR_FRETE: TFloatField
      FieldName = 'VALOR_FRETE'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = ',#0.00'
    end
    object cds_pagVALOR_SEGURO: TFloatField
      FieldName = 'VALOR_SEGURO'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = ',#0.00'
    end
    object cds_pagOUTRAS_DESP: TFloatField
      FieldName = 'OUTRAS_DESP'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = ',#0.00'
    end
    object cds_pagOBS: TGraphicField
      FieldName = 'OBS'
      ProviderFlags = [pfInUpdate]
      BlobType = ftGraphic
    end
    object cds_pagDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      ProviderFlags = []
      Size = 120
    end
    object cds_pagFORMAPAGAMENTO: TStringField
      FieldName = 'FORMAPAGAMENTO'
      ProviderFlags = [pfInUpdate]
      FixedChar = True
    end
    object cds_pagDATAPAGTO: TDateField
      FieldName = 'DATAPAGTO'
      ProviderFlags = [pfInUpdate]
      EditMask = '!99/99/0000;1;_'
    end
    object cds_pagDATABAIXA: TDateField
      FieldName = 'DATABAIXA'
      ProviderFlags = [pfInUpdate]
      EditMask = '!99/99/0000;1;_'
    end
    object cds_pagPARCELAS: TFloatField
      FieldName = 'PARCELAS'
      ProviderFlags = [pfInUpdate]
    end
    object cds_pagTIPO: TStringField
      FieldName = 'TIPO'
      ProviderFlags = [pfInUpdate]
      FixedChar = True
      Size = 1
    end
    object cds_pagNOME: TStringField
      FieldName = 'NOME'
      ProviderFlags = [pfInUpdate]
      Size = 80
    end
    object cds_pagNOME_DEP: TStringField
      FieldName = 'NOME_DEP'
      ProviderFlags = []
      Size = 80
    end
  ...
  object sds_CP: TSQLDataSet
    CommandText = 
      'select r.* '#13#10'        , s.NOME_SOCIO '#13#10'from RECEBIMENTOS r '#13#10'left' +
      ' outer join SOCIOS s on '#13#10's.ID_SOCIO = r.ID_SOCIO  '#13#10'where r.ID_' +
      'DEPREC = :pid'
    MaxBlobSize = -1
    Params = <
      item
    ...
    object sds_CPNOME_SOCIO: TStringField
  ...
  object cds_CP: TClientDataSet
    ...
    object cds_CPNOME_SOCIO: TStringField
      FieldName = 'NOME_SOCIO'
      ProviderFlags = []
      Size = 80
    end
  ...
  object proc_despesa: TSQLClientDataSet
    CommandText = 
      'select p.* '#13#10'        , s.NOME_SOCIO'#13#10'        , c.DESCRICAO '#13#10'fro' +
      'm DESPESA_RECEITA p '#13#10'left outer join SOCIOS s on '#13#10's.ID_SOCIO =' +
      ' p.ID_FORNECEDOR '#13#10'left outer join CCUSTO C on '#13#10'c.ID_CCUSTO = p' +
      '.CODCCUSTO '#13#10'where p.NOME Like :pnome and p.TIPO = '#39'R'#39
    Aggregates = <>
    ...
    object proc_despesaNOME: TStringField
      DisplayLabel = 'Nome'
      FieldName = 'NOME'
      Size = 80
    end

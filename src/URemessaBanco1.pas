...
var
  fRemessaBanco1: TfRemessaBanco1;
...
procedure TfRemessaBanco1.SpeedButton1Click(Sender: TObject);
var caminho : string;
begin
  ...
  if (not cdsBanco.Active) then
   ...
   if Edit8.Text = 'BANCO SANTANDER' then
     Edit5.Text := caminho +'_Avulsa' + Edit2.Text + Edit3.Text +'_' + FormatDateTime('dd_mm_yy', now) + '.txt';
...
procedure TfRemessaBanco1.BitBtn4Click(Sender: TObject);
begin
  SaveDialog1.Execute;
  Edit5.Text := SaveDialog1.FileName;
end;

procedure TfRemessaBanco1.BitBtn2Click(Sender: TObject);
begin
  if Edit8.Text = 'BRASIL' then
  begin
    remessaBB;
...
procedure TfRemessaBanco1.remessaBB;
var
...
procedure TfRemessaBanco1.SpeedButton2Click(Sender: TObject);
begin
...
procedure TfRemessaBanco1.BitBtn1Click(Sender: TObject);
var
...
{ if Edit2.Text = '' then
 ...
 if cdsCR.Active then
  ...
  cdsCR.Params[6].Clear;

  if (t <> 't') then
  cdsCR.Params[0].AsString := Edit2.Text;

  cdsCR.Params[0].AsString := 't';
  ...
  cdsCR.Params[5].AsDate := StrToDate(DateEdit3.Text);
  cdsCR.Params[6].AsDate := StrToDate(DateEdit2.Text);
  cdsCR.Open;
end;

procedure TfRemessaBanco1.dxButton5Click(Sender: TObject);
begin
  close;
end;

procedure TfRemessaBanco1.remessaSANTANDER;
var
   ACedenteTipoInscricao, ASacadoTipoInscricao, aTitulosTipoOcorrencia,
   aTitulosEspecieDocumento,aTitulosAceite, NomArquivo, Registro : string;
   cTotalTitulos: Currency;

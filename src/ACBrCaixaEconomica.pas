...
begin
   ...
   begin
      ...
      Result:= IntToStrZero(ACBrBanco.Numero, 3)                          + //1 a 3 - Código do banco
               ...
               '1'                                                        + //224 - Código para baixa/devolução: Não baixar/não devolver
               padL('030',3,'0')                                             + //225 a 227 - Prazo para baixa/devolução (em dias corridos)
...
begin
   ...
   Result:= IntToStrZero(ACBrBanco.Numero, 3)                          + //Código do banco
            ...
            padL('0', 6, '0')                                           + //Quantidade títulos em cobrança
            padL('0',17, '0')                                           + //Valor dos títulos em carteiras}

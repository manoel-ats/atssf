...
begin
    ...
    if (executou = '') then
    begin
         texto_memo := texto_memo + 'Título nº  ' + IntToStr(cdsTITULO.AsInteger) + ', já Baixado';
         texto_memo := texto_memo + ' Data : ' + cdsDATA.AsString;
         texto_memo := texto_memo + ' Valor R$ : ' + cdsVT.AsString + ')';
         Memo1.Lines.Add(texto_memo);
         texto_memo := '';
...
begin
    ...
    if Edit4.Text <> '' then
     cdsRECCOBRADOR.AsInteger := StrToInt(Edit4.Text);
    texto_memo := texto_memo + 'COBST_SR71 : ';
    texto_memo := 'Título nº: ' + IntToStr(c_retornoTITULO.AsInteger) + ' Data: ' +
    ...
    texto_memo := texto_memo + ' Inscrição : ' + IntToStr(cdsRECN_INSCRICAO.AsInteger);
    texto_memo := texto_memo + ' Inscrição : ' + cdsRECNOME_SOCIO.AsString;
    texto_memo := texto_memo + ' Título : ' + IntToStr(c_retornoTITULO.AsInteger);
    texto_memo := texto_memo + ' Valor R$ : ' + FloatToStr(cdsRECVALOR_RECEBER.AsFloat) + ')';
    Memo1.Lines.Add(texto_memo);
    texto_memo := '';
...
begin
   ...
   begin
     ...
     MessageDlg('Título ' + c_retornoTITULO.AsString + ' Já foi Baixado', mtInformation, [mbOK], 0);
   end;
end;
...
begin
     ...
     begin
       ...
       begin
       texto_memo := texto_memo + 'Não encontrado Título nº  ' + IntToStr(c_retornoTITULO.AsInteger);
    ...
    if (executou = '') then
    begin
         texto_memo := texto_memo + 'Título nº  ' + IntToStr(c_retornoTITULO.AsInteger) + ', já Baixado';
         texto_memo := texto_memo + ' Data : ' + c_retornoDATA.AsString;
         texto_memo := texto_memo + ' Valor R$ : ' + c_retornoVT.AsString + ')';
         Memo1.Lines.Add(texto_memo);
         texto_memo := '';

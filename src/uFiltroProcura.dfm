object fFiltroProcura: TfFiltroProcura
  Left = 2
  Top = 0
  Width = 800
  Height = 600
  ...
  object sds_mensal: TSQLDataSet
    ...
    CommandText = 
      ...
      ' , s.TIPO_SOCIO '#13#10'           , s.CODIGO '#13#10'           , b.BAIRRO ' +
      #13#10'           , m.MUNICIPIO'#13#10'           , c.NOME         '#13#10'from D' +
      'EPENDENTE d '#13#10'left outer join PARENTESCO p on p.ID_PAR=d.ID_PAR ' +
      #13#10'left outer join SOCIOS s on s.ID_SOCIO=d.ID_SOCIO '#13#10'left outer' +
      ' join ENDERECO e on e.ID_SOCIO=s.ID_SOCIO '#13#10'left outer join BAIR' +
      'RO b on b.ID_BAIRRO=e.ID_BAIRRO '#13#10'left outer join MUNICIPIO m on' +
      ' m.ID_MUNICIPIO=e.ID_MUNICIPIO '#13#10'left outer join COBRANCA c on c' +
      '.ID_COB=s.ID_COB '#13#10'where s.TIPO_SOCIO = '#39'M'#39' '#13#10'and ((e.TIPOEND = ' +
    ...
    object sds_mensalCODIGO: TIntegerField
      FieldName = 'CODIGO'
    end
  end
  ...
  object cds_mensal: TClientDataSet
    ...
    object cds_mensalCODIGO: TIntegerField
      FieldName = 'CODIGO'
    end
  end
end

inherited Cad_Obitos: TCad_Obitos
  ...
  object PageControl1: TPageControl [6]
    ...
    object TabSheet4: TTabSheet
      ...
      object grp1: TGroupBox
        ...
        PopupMenu = PopupMenu1
        TabOrder = 2
        object dbedtGRAU_PARENTESCO: TDBEdit
          Left = 5
          Top = 12
          Width = 163
          Height = 24
  ...
  object sds_CR: TSQLDataSet
    CommandText = 
      ...
      'pob   '#13#10'and SITUACAO = '#39'Ativo'#39' '#13#10'order by  VENCIMENTO, LOTE, TIT' +
      'ULO'
    MaxBlobSize = -1
    Params = <
      item
  ...
  object cds_CR: TClientDataSet
    ...
    ProviderName = 'dsp_CR'
    OnDeleteError = cds_CRDeleteError
    Left = 553
    Top = 450
  ...
  object SQLClientDataSet1: TSQLClientDataSet
    CommandText = 
      'select * from LOTES '#13#10' where GEROU = :gera '#13#10'and grupo = :gr'#13#10#13#10 +
      'order by grupo , id_lote desc'#13#10
    Aggregates = <>
    Options = [poAllowCommandText]
    ObjectView = True
    Params = <

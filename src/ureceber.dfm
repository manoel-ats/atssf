object fReceber: TfReceber
  ...
  object DBEdit3: TJvDBDatePickerEdit
    Left = 388
    Top = 208
    Width = 181
    Height = 33
  ...
  object busca_cr: TSQLDataSet
    CommandText = 
      'select ID_RECEBIMENTOS, ID, STATUS, ORIGEM from RECEBIMENTOS '#13#10'W' +
      'HERE ORIGEM = :ID'
    MaxBlobSize = -1
    Params = <
      item
    ...
    Left = 24
    Top = 288
    object busca_crID_RECEBIMENTOS: TIntegerField
      FieldName = 'ID_RECEBIMENTOS'
      Required = True
    end
    object busca_crID: TIntegerField
      FieldName = 'ID'
    end
    object busca_crSTATUS: TStringField
      FieldName = 'STATUS'
      Size = 30
    end
    object busca_crORIGEM: TIntegerField
      FieldName = 'ORIGEM'
    end
  end
  object sds_parametro: TSQLDataSet
    CommandText = 'select * from PARAMETROS where PARAMETRO = :PPARAM'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftString
  ...
  object cds_param: TClientDataSet
    ...
    Left = 432
    Top = 48
    object cds_paramPARAMETRO: TStringField
      FieldName = 'PARAMETRO'
      Required = True
      Size = 60
    end
    object cds_paramDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
    ...
    object cds_paramPARAMETRO1: TStringField
      FieldName = 'PARAMETRO1'
      Size = 40
    end
    object cds_paramPARAMETRO2: TStringField
      FieldName = 'PARAMETRO2'
      Size = 40
    end
    object cds_paramPARAMETRO3: TStringField
      FieldName = 'PARAMETRO3'
      Size = 40
    end
    object cds_paramPARAMETRO4: TStringField
      FieldName = 'PARAMETRO4'
      Size = 40
    end
    object cds_paramPARAMETRO5: TStringField
      FieldName = 'PARAMETRO5'
      Size = 40
    end
    object cds_paramPARAMETRO6: TStringField
      FieldName = 'PARAMETRO6'
      Size = 40
    end
    object cds_paramPARAMETRO7: TStringField
      FieldName = 'PARAMETRO7'
      Size = 40
    end
    object cds_paramPARAMETRO8: TStringField
      FieldName = 'PARAMETRO8'
      Size = 40
    end
    object cds_paramPARAMETRO9: TStringField
      FieldName = 'PARAMETRO9'
      Size = 40
    end
  end

...
uses UDM, UfDlgLogin, UnitDlgNovoUsuario, uNovoUsuario, uAlteraSenha,
  uPrincipal, uUsuario_acesso, uAcesso, uGerencia_Acessos;
...
begin
  ...
  if not odd(dm.cds_senha.RecNo) then // se for impar

...
procedure TCad_Obitos.DBRadioGroup5Click(Sender: TObject);
begin
  inherited;
  if DBRadioGroup5.ItemIndex=0 then
    dm.cds_ObitosRG_CPF.EditMask := '000.000.000-00;1;_'
  else
   dm.cds_ObitosRG_CPF.EditMask := '';
...
begin
  ...
  begin
     ...
     dm.cdsCircular.ApplyUpdates(0);
     dm.cdsCircular.Close;
     dm.cds_ObitosLOTE.AsInteger := sdsProcLoteMAX.AsInteger + 1;
...
var
  grupo_lote : integer;
begin
    {** se o sócio for da Cidade de Vinhedo e for do grupo B ele é Trimestral
    se fro trimestral adiciono o falecimento ao grupo A...}
    if dm.cds_ObitosGRUPO.AsString = 'B' then
    begin
